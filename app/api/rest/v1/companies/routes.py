...
async def get_shareholders(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve shareholders: {str(e)}")
...
async def get_subsidiaries(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve subsidiaries: {str(e)}")
...
async def get_company_news(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve company news: {str(e)}")
...
async def get_dividends(
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Failed to retrieve dividends: {str(e)}")
